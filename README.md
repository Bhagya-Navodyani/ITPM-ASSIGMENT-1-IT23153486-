...
python test_automation.py `
  --excel "IT23153486_Assignment 1 - Test cases.xlsx" `
  --input-col "Input" `
...
├── IT23153486_Assignment 1 - Test cases.xlsx  # Test data (200 rows)
├── IT23153486_Commands.txt                     # Quick reference commands
├── IT23153486_README.md                        # This file
├── test_automation.py                          # Main test runner script
├── test.py                                    # Simple Playwright example
└── test_automation/
    └── test_automation/
        └── test_automation.py                 # Alternate test runner location
```
...
**File Name:** IT23153486_Assignment 1 - Test cases.xlsx
